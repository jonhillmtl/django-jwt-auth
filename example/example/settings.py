...
SECRET_KEY = 'f)+t&f)_5%4ce3b%@zhnj4br*-g=(hp7jagi6kt+e21rur%$ok'
...
# TODO DEVELOPER: these are the settings you need in your settings.py file

# JSONWebTokenAuthenticationBackend configuration below here
